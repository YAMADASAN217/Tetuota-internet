<html dir="ltr" lang="ja" class="" lazy-loaded="true"><head>
    <meta charset="utf-8">
    <title>新しいタブ</title>
    <style>
      body {
...
<slot></slot>
  ...
  <body style="background-color: rgb(255, 255, 255);">
    ...
    <ntp-app realbox-can-show-secondary-side="" modules-loaded-status_="0" ntp-realbox-next-enabled_="" realbox-layout-mode_="TallBottomContext" style="--ntp-logo-color: rgba(0, 104, 117, 1.00); --color-new-tab-page-attribution-foreground: rgba(0, 0, 0, 1.00); --color-new-tab-page-most-visited-foreground: rgba(0, 0, 0, 1.00);"><template shadowrootmode="open"><!----><!--_html_template_start_--><!-- #html_wrapper_imports_start
...
<!--_html_template_end_--></template> <!-- presubmit: ignore-long-line -->
  ...
  <!-- TODO(crbug.com/40743294): Instead of ?hidden="lit$900727446$" it would
  ...
  <ntp-logo id="logo" single-colored=""><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$900727446$-->
  <div id="logo"></div>
...
<!--_html_template_end_--></template>
  ...
  <div id="searchboxContainer">
    <cr-searchbox id="searchbox" placeholder-text="Google で調べる" can-show-secondary-side="" compose-button-enabled="" composebox-enabled="" realbox-layout-mode="TallBottomContext" ntp-realbox-next-enabled="" cycling-placeholders="" searchbox-lens-search-enabled="" searchbox-voice-search-enabled_="" searchbox-lens-search-enabled_="" use-webkit-search-icons_="" shown=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<!--?lit$900727446$-->
<ntp-error-scrim id="errorScrim"><template shadowrootmode="open"><!----><!--_html_template_start_-->
  <!--?lit$900727446$-->
<!--_html_template_end_--></template>
</ntp-error-scrim>
<div id="inputWrapper">
  <input id="input" class="truncate" type="search" autocomplete="off" part="searchbox-input" spellcheck="false" role="combobox" aria-controls="matches" aria-live="polite" aria-expanded="false" aria-description="" placeholder="新しいスキルを身に付ける">
...
<div id="container" style="--container-bg-color:transparent;">
  ...
  <div>
    ...
    <div id="faviconImageContainer" hidden="">
      <img id="faviconImage" src="" srcset="">
    </div>
  </div>

  <img id="iconImg" src="" hidden="">
</div>
<!--_html_template_end_--></template>
  </cr-searchbox-icon>
  <!--?lit$900727446$-->
...
<div id="glowAnimationWrapper" class="glow-container">
  ...
  <cr-button id="composeButton" class="compose-container" title="Google AI モードに質問する" role="button" tabindex="0" aria-disabled="false" has-prefix-icon_=""><template shadowrootmode="open"><!---->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <img slot="prefix-icon" class="compose-icon" src="//resources/cr_components/searchbox/icons/search_spark.svg">
    <!--?lit$900727446$-->AI モード
  </cr-button>
</div>
<!--_html_template_end_--></template>
  ...
  <!--?lit$900727446$-->
    <div class="dropdownContainer">
      <contextual-entrypoint-and-carousel id="context" part="contextual-entrypoint-and-carousel" exportparts="composebox-entrypoint" entrypoint-name="Realbox" realbox-layout-mode="TallBottomContext"><template shadowrootmode="open"><!----><!--_html_template_start_-->
  <!--?lit$900727446$-->
  <!--?lit$900727446$-->
  <!--?lit$900727446$-->
  <!--?lit$900727446$-->
  ...
  <!--?lit$900727446$-->
    <!--?lit$900727446$-->
      <div class="context-menu-container">
        <composebox-context-menu-entrypoint id="contextEntrypoint" part="composebox-entrypoint" class="upload-icon no-overlap" show-context-menu-description=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
    <!--?lit$900727446$-->
    <cr-button id="entrypoint" title="検索にタブまたはファイルを追加して、ツールも使用する" role="button" tabindex="0" aria-disabled="false" has-prefix-icon_=""><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      <cr-icon id="entrypointIcon" icon="cr:add" slot="prefix-icon"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_">
 <g>
        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
      </g></svg><!----></template></cr-icon>
      <span id="description"><!--?lit$900727446$-->タブなどを追加</span>
    </cr-button>
    

  <cr-action-menu id="menu" role-description="メニュー"><template shadowrootmode="open"><!---->
<dialog id="dialog" part="dialog" role="application" aria-roledescription="メニュー">
  <div id="wrapper" class="item-wrapper" role="menu" tabindex="-1">
    <slot id="contentNode"></slot>
  </div>
</dialog></template>
    <!--?lit$900727446$-->
      <h4 id="tabHeader"><!--?lit$900727446$-->最近使ったタブ</h4>
      <!--?lit$900727446$--><!---->
        <div class="suggestion-container">
          <button class="dropdown-item" title="Google Gemini" data-index="0" aria-label="最近使ったタブ, Google Gemini">
            <composebox-tab-favicon style="background-image: image-set(url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fgemini.google.com%2Fapp%2Fec17e7cc6fe5f23f&amp;allowGoogleServerFallback=0&quot;) 1x, url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fgemini.google.com%2Fapp%2Fec17e7cc6fe5f23f&amp;allowGoogleServerFallback=0&quot;) 2x);"><template shadowrootmode="open"><!----></template>
            </composebox-tab-favicon>
            <span class="tab-title"><!--?lit$900727446$-->Google Gemini</span>
          </button>
          <!--?lit$900727446$-->
        </div>
      <!----><!---->
        <div class="suggestion-container">
          <button class="dropdown-item" title="「このアプリはお使いのPCでは実行できません」エラーが出ると、どうしたらいいか" data-index="1" aria-label="最近使ったタブ, 「このアプリはお使いのPCでは実行できません」エラーが出ると、どうしたらいいか">
            <composebox-tab-favicon style="background-image: image-set(url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Frecoverit.wondershare.jp%2Fwindows-error%2Fhow-to-fix-the-this-app-cannot-be-run-on-your-pc.html&amp;allowGoogleServerFallback=0&quot;) 1x, url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Frecoverit.wondershare.jp%2Fwindows-error%2Fhow-to-fix-the-this-app-cannot-be-run-on-your-pc.html&amp;allowGoogleServerFallback=0&quot;) 2x);"><template shadowrootmode="open"><!----></template>
            </composebox-tab-favicon>
            <span class="tab-title"><!--?lit$900727446$-->「このアプリはお使いのPCでは実行できません」エラーが出ると、どうしたらいいか</span>
          </button>
          <!--?lit$900727446$-->
        </div>
      <!----><!---->
        <div class="suggestion-container">
          <button class="dropdown-item" title="html .exe - Google 検索" data-index="2" aria-label="最近使ったタブ, html .exe - Google 検索">
            <composebox-tab-favicon style="background-image: image-set(url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dhtml%2B.exe%26oq%3Dhtml%2B.exe%26gs_lcrp%3DEgZjaHJvbWUyBggAEEUYOTIICAEQABgEGB4yCAgCEAAYBBgeMgYIAxAAGB4yBggEEAAYHjIGCAUQABgeMggIBhAAGAQYHjIICAcQABgEGB4yCAgIEAAYBBgeMggICRAAGAQYHtIBCDM2MTJqMGo3qAIAsAIA%26sourceid%3Dchrome%26ie%3DUTF-8&amp;allowGoogleServerFallback=0&quot;) 1x, url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dhtml%2B.exe%26oq%3Dhtml%2B.exe%26gs_lcrp%3DEgZjaHJvbWUyBggAEEUYOTIICAEQABgEGB4yCAgCEAAYBBgeMgYIAxAAGB4yBggEEAAYHjIGCAUQABgeMggIBhAAGAQYHjIICAcQABgEGB4yCAgIEAAYBBgeMggICRAAGAQYHtIBCDM2MTJqMGo3qAIAsAIA%26sourceid%3Dchrome%26ie%3DUTF-8&amp;allowGoogleServerFallback=0&quot;) 2x);"><template shadowrootmode="open"><!----></template>
            </composebox-tab-favicon>
            <span class="tab-title"><!--?lit$900727446$-->html .exe - Google 検索</span>
          </button>
          <!--?lit$900727446$-->
        </div>
      <!----><!---->
        <div class="suggestion-container">
          <button class="dropdown-item" title="Download Python | Python.org" data-index="3" aria-label="最近使ったタブ, Download Python | Python.org">
            <composebox-tab-favicon style="background-image: image-set(url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fwww.python.org%2Fdownloads%2F&amp;allowGoogleServerFallback=0&quot;) 1x, url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fwww.python.org%2Fdownloads%2F&amp;allowGoogleServerFallback=0&quot;) 2x);"><template shadowrootmode="open"><!----></template>
            </composebox-tab-favicon>
            <span class="tab-title"><!--?lit$900727446$-->Download Python | Python.org</span>
          </button>
          <!--?lit$900727446$-->
        </div>
      <!----><!---->
        <div class="suggestion-container">
          <button class="dropdown-item" title="exeインストール - Google 検索" data-index="4" aria-label="最近使ったタブ, exeインストール - Google 検索">
            <composebox-tab-favicon style="background-image: image-set(url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dexe%25E3%2582%25A4%25E3%2583%25B3%25E3%2582%25B9%25E3%2583%2588%25E3%2583%25BC%25E3%2583%25AB%26oq%3Dexe%25E3%2582%25A4%25E3%2583%25B3%25E3%2582%25B9%25E3%2583%2588%25E3%2583%25BC%25E3%2583%25AB%26gs_lcrp%3DEgZjaHJvbWUyBggAEEUYOTIICAEQABgNGB4yCggCEAAYgAQYogQyCggDEAAYogQYiQUyCggEEAAYogQYiQXSAQgyNzA4ajBqN6gCB7ACAfEFNDMzjMBgiHs%26sourceid%3Dchrome%26ie%3DUTF-8&amp;allowGoogleServerFallback=0&quot;) 1x, url(&quot;chrome://favicon2/?size=16&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Dexe%25E3%2582%25A4%25E3%2583%25B3%25E3%2582%25B9%25E3%2583%2588%25E3%2583%25BC%25E3%2583%25AB%26oq%3Dexe%25E3%2582%25A4%25E3%2583%25B3%25E3%2582%25B9%25E3%2583%2588%25E3%2583%25BC%25E3%2583%25AB%26gs_lcrp%3DEgZjaHJvbWUyBggAEEUYOTIICAEQABgNGB4yCggCEAAYgAQYogQyCggDEAAYogQYiQUyCggEEAAYogQYiQXSAQgyNzA4ajBqN6gCB7ACAfEFNDMzjMBgiHs%26sourceid%3Dchrome%26ie%3DUTF-8&amp;allowGoogleServerFallback=0&quot;) 2x);"><template shadowrootmode="open"><!----></template>
            </composebox-tab-favicon>
            <span class="tab-title"><!--?lit$900727446$-->exeインストール - Google 検索</span>
          </button>
          <!--?lit$900727446$-->
        </div>
      <!---->
    ...
    <button id="imageUpload" class="dropdown-item" role="menuitem">
      <cr-icon icon="composebox:imageUpload"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_">
 <g>
        <path d="M5 21C4.45 21 3.975 20.8083 3.575 20.425C3.19167 20.025 3 19.55 3 19V5C3 4.45 3.19167 3.98333 3.575 3.6C3.975 3.2 4.45 3 5 3H13C13 3.28333 13 3.59167 13 3.925C13 4.25833 13 4.61667 13 5H5V19H19V11C19.3833 11 19.7417 11 20.075 11C20.4083 11 20.7167 11 21 11V19C21 19.55 20.8 20.025 20.4 20.425C20.0167 20.8083 19.55 21 19 21H5ZM6 17H18L14.25 12L11.25 16L9 13L6 17ZM17 9V7H15V5H17V3H19V5H21V7H19V9H17Z" fill="currentColor"></path>
      </g></svg><!----></template></cr-icon>
      <!--?lit$900727446$-->画像を追加
    </button>
    <button id="fileUpload" class="dropdown-item" role="menuitem">
      <cr-icon icon="composebox:fileUpload"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_">
 <g>
        <path d="M18 15.75C18 17.4833 17.3917 18.9583 16.175 20.175C14.9583 21.3917 13.4833 22 11.75 22C10.0167 22 8.54167 21.3917 7.325 20.175C6.10833 18.9583 5.5 17.4833 5.5 15.75V6.5C5.5 5.25 5.93333 4.19167 6.8 3.325C7.68333 2.44167 8.75 2 10 2C11.25 2 12.3083 2.44167 13.175 3.325C14.0583 4.19167 14.5 5.25 14.5 6.5V15.25C14.5 16.0167 14.2333 16.6667 13.7 17.2C13.1667 17.7333 12.5167 18 11.75 18C10.9833 18 10.3333 17.7333 9.8 17.2C9.26667 16.6667 9 16.0167 9 15.25V6H11V15.25C11 15.4667 11.0667 15.65 11.2 15.8C11.35 15.9333 11.5333 16 11.75 16C11.9667 16 12.1417 15.9333 12.275 15.8C12.425 15.65 12.5 15.4667 12.5 15.25V6.5C12.4833 5.8 12.2333 5.20833 11.75 4.725C11.2833 4.24167 10.7 4 10 4C9.3 4 8.70833 4.24167 8.225 4.725C7.74167 5.20833 7.5 5.8 7.5 6.5V15.75C7.48333 16.9333 7.89167 17.9417 8.725 18.775C9.55833 19.5917 10.5667 20 11.75 20C12.9167 20 13.9083 19.5917 14.725 18.775C15.5417 17.9417 15.9667 16.9333 16 15.75V6H18V15.75Z" fill="currentColor"></path>
      </g></svg><!----></template></cr-icon>
      <!--?lit$900727446$-->ファイルを追加
    </button>
    <!--?lit$900727446$-->
    <!--?lit$900727446$-->
    <!--?lit$900727446$-->
...
<!--_html_template_end_--></template>
        ...
        <!--?lit$900727446$-->
        <!--?lit$900727446$-->
        <composebox-tool-chip icon="composebox:deepSearch" label="Deep Search"><template shadowrootmode="open"><!----></template>
        </composebox-tool-chip>
        <composebox-tool-chip icon="composebox:nanoBanana" label="画像を作成"><template shadowrootmode="open"><!----></template>
        </composebox-tool-chip>
...
<!--_html_template_end_--></template>
        <cr-searchbox-dropdown id="matches" part="searchbox-dropdown" exportparts="dropdown-content" role="listbox" selected-match-index="-1" can-show-secondary-side="" hidden=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
...
<!--_html_template_end_--></template>
  ...
  <!--?lit$900727446$-->
    <div class="searchbox-icon-button-container voice">
      <button id="voiceSearchButton" class="searchbox-icon-button" title="音声検索">
      </button>
    </div>
  ...
  <!--?lit$900727446$-->
    <div class="searchbox-icon-button-container lens">
      <button id="lensSearchButton" class="searchbox-icon-button lens" title="フォローアップを依頼する画面の領域を選択">
      </button>
    </div>
...
<!--_html_template_end_--></template>
  ...
  <!--?lit$900727446$-->
    <cr-toast id="webstoreToast" duration="10000" hidden=""><template shadowrootmode="open"><!----><slot></slot></template>
      <div>以前の色は Chrome ウェブストアから入手できます</div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
  ...
  <!--?lit$900727446$-->
    <!--?lit$900727446$-->
      <cr-most-visited id="mostVisited" single-row="" reflow-on-overflow="" visible_="" custom-links-enabled_=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="container" style="--tile-background-color: rgba(219, 228, 230, 1.00); --column-count: 5; --row-count: 1;">
  <!--?lit$900727446$--><!---->
    <div class="tile" draggable="true" title="Scratch" data-index="0">
      <a draggable="false" href="https://scratch.mit.edu/" aria-label="Scratch">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="Scratch ショートカットのその他の操作" data-index="0" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <cr-icon-button id="removeButton" class="icon-clear" tabindex="0" title="削除" hidden="" data-index="0" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fscratch.mit.edu%2F">
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$900727446$--></slot>
</cr-tooltip></template>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$900727446$-->Scratch</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="‎Google Gemini" data-index="1">
      <a draggable="false" href="https://gemini.google.com/" aria-label="‎Google Gemini">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="‎Google Gemini ショートカットのその他の操作" data-index="1" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <cr-icon-button id="removeButton" class="icon-clear" tabindex="0" title="削除" hidden="" data-index="1" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fgemini.google.com%2F">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
        <div class="managed-tile-icon" hidden="">
          <cr-policy-indicator indicator-type="userPolicy"><template shadowrootmode="open"><!---->
<cr-tooltip-icon tooltip-text="" icon-class="cr20:domain" icon-aria-label=""><template shadowrootmode="open"><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$900727446$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$900727446$-->‎Google Gemini</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="ワークスペース" data-index="2">
      <a draggable="false" href="https://vscode.dev/" aria-label="ワークスペース">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="ワークスペース ショートカットのその他の操作" data-index="2" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <cr-icon-button id="removeButton" class="icon-clear" tabindex="0" title="削除" hidden="" data-index="2" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fvscode.dev%2F">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
        <div class="managed-tile-icon" hidden="">
          <cr-policy-indicator indicator-type="userPolicy"><template shadowrootmode="open"><!---->
<cr-tooltip-icon tooltip-text="" icon-class="cr20:domain" icon-aria-label=""><template shadowrootmode="open"><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$900727446$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$900727446$-->ワークスペース</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="ウェブストア" data-index="3">
      <a draggable="false" href="https://chrome.google.com/webstore?hl=ja" aria-label="ウェブストア">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="ウェブストア ショートカットのその他の操作" data-index="3" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <cr-icon-button id="removeButton" class="icon-clear" tabindex="0" title="削除" hidden="" data-index="3" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fchrome.google.com%2Fwebstore%3Fhl%3Dja">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
        <div class="managed-tile-icon" hidden="">
          <cr-policy-indicator indicator-type="userPolicy"><template shadowrootmode="open"><!---->
<cr-tooltip-icon tooltip-text="" icon-class="cr20:domain" icon-aria-label=""><template shadowrootmode="open"><!---->
...
<cr-tooltip id="tooltip" for="indicator" fit-to-visible-bounds="" part="tooltip" position="top" style="--paper-tooltip-delay-in: 500ms; --cr-tooltip-offset: 14px;"><template shadowrootmode="open"><!---->
  ...
  <slot name="tooltip-text"><!--?lit$900727446$--></slot>
      ...
      <div class="tile-title title-ltr">
        <span><!--?lit$900727446$-->ウェブストア</span>
      </div>
    </div>
  <!---->
  <cr-button id="addShortcut" tabindex="0" noink="" aria-label="ショートカットを追加" title="ショートカットを追加" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$900727446$-->ショートカットを追加</span>
    </div>
  </cr-button>
  <cr-button id="showMore" tabindex="0" noink="" hidden="" aria-label="表示項目を増やす" title="表示項目を増やす" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$900727446$-->表示項目を増やす</span>
    </div>
  </cr-button>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$900727446$--></div>
    <div slot="body" id="dialogContent">
      <!--?lit$900727446$-->
      <cr-input id="dialogInputName" spellcheck="false" autofocus="" label="名前"><template shadowrootmode="open"><!---->
  ...
  <div id="input-container">
    <div id="inner-input-container">
      ...
      <div id="inner-input-content">
        ...
        <input id="input" part="input" autocomplete="off" autofocus="" tabindex="0" type="text" maxlength="" minlength="" inputmode="" aria-label="名前" aria-invalid="false">
...
<div id="error" aria-live="assertive"><!--?lit$900727446$--></div></template>
      </cr-input>
...
<cr-toast id="toast"><template shadowrootmode="open"><!----><slot></slot></template>
  ...
  <cr-button id="undo" aria-label="元に戻すには Ctrl+Z を押します" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
  ...
  <cr-button id="restore" aria-label="デフォルトのショートカットに戻す" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <!--?lit$900727446$-->デフォルトのショートカットに戻す
  </cr-button>
</cr-toast-manager>
<!--_html_template_end_--></template>
      </cr-most-visited>
...
<cr-toast id="dismissPromoButtonToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
  ...
  <cr-button id="undoDismissPromoButton" aria-label="元に戻すには Ctrl+Z を押します" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$900727446$-->
    <!--?lit$900727446$-->
        <setup-list-module-wrapper maxpromos="10" maxcompletedpromos="2"><template shadowrootmode="open"><!---->
<div id="container">
  <div id="moduleElement">
    <setup-list id="setupList" maxpromos="10" maxcompletedpromos="2"><template shadowrootmode="open"><!---->
<ntp-module-header-v2 id="moduleHeaderElementV2" hide-customize="" header-text="Chromium を自分好みに" more-actions-text="Chromium を自分好みに に対するその他の操作"><template shadowrootmode="open"><!----><!--_html_template_start_--><div id="titleContainer">
  <h2 id="title"><!--?lit$900727446$-->Chromium を自分好みに</h2>
  <div id="headerSpacer"></div>
  <slot name="title-actions"></slot>
  <cr-icon-button id="menuButton" class="icon-more-vert" title="Chromium を自分好みに に対するその他の操作" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
  </cr-icon-button>
...
<cr-action-menu id="actionMenu" role-description="その他の操作"><template shadowrootmode="open"><!---->
<dialog id="dialog" part="dialog" role="application" aria-roledescription="その他の操作">
  <div id="wrapper" class="item-wrapper" role="menu" tabindex="-1">
    <slot id="contentNode"></slot>
  </div>
</dialog></template>
  <!--?lit$900727446$--><!---->
    <button class="dropdown-item" id="dismiss" data-action="dismiss" role="menuitem">
      <cr-icon class="action-menu-icon cr-icon" icon="modules:visibility_off"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 -960 960 960" class="cr-iconset-svg-icon_">
 <g viewBox="0 -960 960 960">
        <path d="m638.435-429.065-72.283-72.283q2.326-29.391-18.337-49.717t-48.38-18l-70.37-70.37q12.283-4.282 25.446-6.424Q467.674-648 480-648q70 0 119 49t49 119q0 11.848-2.141 25.489-2.142 13.641-7.424 25.446ZM777.652-289.37l-56.782-57.26q34.326-27.522 62.75-60.185 28.423-32.663 48.902-73.185-49.479-100.761-144.5-158.38Q593-696 480-696q-26 0-49.685 2.761-23.685 2.761-46.011 9.043l-64.217-64.217q38-15 78.456-21 40.457-6 81.457-6 144.435 0 264.967 78.695Q865.5-618.022 919.413-480q-22 57.478-58.978 104.935-36.978 47.456-82.783 85.695ZM765.13-87.13 639.435-213.065q-37.522 14.239-77.5 21.359-39.978 7.119-81.935 7.119-144.674 0-265.207-78.935Q94.261-342.456 40.587-480q21.76-56.522 58-104.359 36.239-47.837 83.761-86.793l-99.044-98.565 53.631-53.631 681.587 682.826L765.13-87.13ZM238.848-614.37q-34.522 28.479-63.207 60.544-28.684 32.065-47.924 73.826 49 101 144.142 158.5Q367-264 480-264q23.848 0 47.772-3.141 23.924-3.142 48.924-9.142l-45-45q-12.805 4.761-25.848 7.022Q492.804-312 480-312q-70 0-119-49t-49-119q0-12.565 3.141-25.728 3.142-13.163 5.663-25.968l-81.956-82.674Zm292.739 84.457Zm-102.935 99.587Z">
        </path>
      </g></svg><!----></template></cr-icon>
      <!--?lit$900727446$-->7 日間表示しない
    </button>
  <!----><!---->
 ...
 <g viewBox="0 -960 960 960">
      ...
      <!--?lit$900727446$-->Chromium を自分好みにを表示しない
    </button>
  <!---->
  <!--?lit$900727446$-->
</cr-action-menu>
...
<div id="promos">
  <!--?lit$900727446$--><!---->
    <setup-list-item body-icon-name="my_extensions" body-text="拡張機能を追加して、情報を整理したり、タスクを簡素化したり、ブラウジング環境をカスタマイズしたりできます" action-button-text="拡張機能を追加して、情報を整理したり、タスクを簡素化したり、ブラウジング環境をカスタマイズしたりできます" promo-id="Extensions"><template shadowrootmode="open"><!---->
<button id="backing" class="pending" aria-label="拡張機能を追加して、情報を整理したり、タスクを簡素化したり、ブラウジング環境をカスタマイズしたりできます">
  <cr-icon id="bodyIcon" class="" icon="ntp-promo:my_extensions"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 -960 960 960" class="cr-iconset-svg-icon_">
 <g viewBox="0 -960 960 960"><path d="M216-135.869q-33.287 0-56.709-23.422-23.422-23.422-23.422-56.709v-172.304q37.609-2 63.218-28.424 25.608-26.424 25.608-63.272t-25.608-63.272q-25.609-26.424-63.218-28.424V-744q0-33.287 23.422-56.709 23.422-23.422 56.709-23.422h161.065q2.631-40.956 31.96-69.315 29.329-28.359 70.75-28.359t70.975 28.199q29.554 28.199 32.185 69.475H744q33.287 0 56.709 23.422 23.422 23.422 23.422 56.709v161.065q40.956 2.631 69.315 31.96 28.359 29.329 28.359 70.75t-28.199 70.975q-28.199 29.554-69.475 32.185V-216q0 33.287-23.422 56.709-23.422 23.422-56.709 23.422H216Zm2.87-83.001h522.26v-522.26H218.87v108.652q42.13 22.63 65.597 63.772 23.468 41.141 23.468 88.706 0 49.01-23.468 90.168Q261-348.674 218.87-327.283v108.413ZM480-480Z"></path></g></svg><!----></template>
  </cr-icon>
  <p id="bodyText"><!--?lit$900727446$-->拡張機能を追加して、情報を整理したり、タスクを簡素化したり、ブラウジング環境をカスタマイズしたりできます</p>
  <cr-icon id="actionIcon" icon="cr:chevron-right"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_">
 <g>
        <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path>
      </g></svg><!----></template></cr-icon>
</button>
...
<cr-toast id="undoToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
  <div id="undoToastMessage"><!--?lit$900727446$--></div>
  <!--?lit$900727446$-->
</cr-toast>
</template>
  ...
  <!--?lit$900727446$-->
      <a id="backgroundImageAttribution" href="" hidden="">
      ...
      <ntp-customize-buttons id="customizeButtons" show-shadow="" show-customize-chrome-text=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="customizeButtons">
  <!--?lit$900727446$-->
  <cr-button id="customizeButton" class="customize-button" title="このページをカスタマイズ" aria-pressed="false" role="button" tabindex="0" aria-disabled="false" data-native-id="NewTabPageUI::kCustomizeChromeButtonElementId" has-prefix-icon_=""><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<svg>
  <defs>
    ...
    <rect x="0" y="0" width="982.4000244140625" height="68.79999923706055"></rect></clipPath>
  </defs>
</svg>
